...
class ComandaCancelada implements ShouldBroadcastNow
{
    use Dispatchable, InteractsWithSockets, SerializesModels;

    /**
     * Crea una nueva instancia del evento de comanda cancelada.
     */
    ...
    {
        return [
            'message' => 'Comanda cancelada antes de preparación.',
