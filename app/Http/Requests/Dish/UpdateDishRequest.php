...
#[OA\Schema(
    ...
    description: 'Datos para actualizar un platillo existente, su receta y complementos asociados',
    required: ['name', 'category_id', 'price'],
    example: [
        'name' => 'Pollo Frito Familiar Especial',
        'category_id' => 1,
        'description' => '8 piezas crujientes de pollo con receta secreta',
        'price' => 135.00,
        'image_url' => 'https://cdn.pollocharly.com/dishes/familiar-especial.jpg',
        'is_daily_menu' => false,
        'is_active' => true,
        'recipes' => [
    ...
    properties: [
        new OA\Property(property: 'name', description: 'Nombre único del platillo', type: 'string', maxLength: 150, example: 'Pollo Frito Familiar Especial'),
        ...
        new OA\Property(property: 'price', description: 'Precio de venta (mayor a 0)', type: 'number', format: 'float', example: 135.00),
        new OA\Property(property: 'image_url', description: 'URL de la imagen del platillo', type: 'string', nullable: true, example: 'https://cdn.pollocharly.com/dishes/familiar-especial.jpg'),
        new OA\Property(property: 'is_daily_menu', description: 'Indica si forma parte del menú del día', type: 'boolean', example: false),
        new OA\Property(property: 'is_active', description: 'Estado del platillo', type: 'boolean', example: true),
        new OA\Property(
            property: 'recipes',
            description: 'Lista de insumos y cantidades requeridas por porción (reemplaza la receta anterior)',
            type: 'array',
            items: new OA\Items(ref: '#/components/schemas/CreateDishRecipeItemInput')
        ),
        new OA\Property(
            property: 'complements',
            description: 'IDs de complementos aplicables al platillo (reemplaza la lista anterior)',
            type: 'array',
...
class UpdateDishRequest extends FormRequest
{
    ...
    {
        $dishParam = $this->route('dish');
        $dishId = $dishParam instanceof Dish ? $dishParam->id : $dishParam;
