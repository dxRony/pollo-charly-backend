...
#[OA\Schema(
    schema: 'UpdateSupplyRequest',
    title: 'Update Supply Request',
    description: 'Datos permitidos para modificar un producto o insumo existente sin alterar su existencia física ni su historial',
    required: ['name', 'measurement_unit_id', 'minimum_stock', 'unit_cost'],
    example: [
        'code' => 'INS-0001',
        'name' => 'Pechuga de Pollo Fresca Especial',
    ...
    properties: [
        new OA\Property(property: 'code', description: 'Código único de identificación', type: 'string', maxLength: 50, nullable: true, example: 'INS-0001'),
        new OA\Property(property: 'name', description: 'Nombre descriptivo del producto o insumo', type: 'string', maxLength: 150, example: 'Pechuga de Pollo Fresca Especial'),
        new OA\Property(property: 'measurement_unit_id', description: 'ID de la unidad de medida', type: 'integer', example: 1),
        new OA\Property(property: 'minimum_stock', description: 'Cantidad de referencia mínima requerida en almacén (mayor a 0)', type: 'number', format: 'float', example: 20.00),
        new OA\Property(property: 'unit_cost', description: 'Costo unitario de adquisición (mayor o igual a 0)', type: 'number', format: 'float', example: 38.00),
...
class UpdateSupplyRequest extends FormRequest
{
    ...
    /**
     * Reglas de validación aplicadas a la actualización del insumo.
     *
     * @return array<string, array<int, mixed>>
     */
    public function rules(): array
    {
        $supplyParam = $this->route('supply');
        $supplyId = $supplyParam instanceof Supply ? $supplyParam->id : $supplyParam;
        ...
        return [
            ...
            'code' => [
                ...
                'string',
                'max:50',
                Rule::unique('supplies', 'code')->ignore($supplyId),
            ],
